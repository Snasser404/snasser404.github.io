...
- Website development: builds on whatever fits the business — custom-coded (HTML/CSS/JS), WordPress, or Wix/Shopify (e.g. a 31-page custom-coded site for Serene Touch, a Wix booking site for Paradise Wellness) — plus the SEO/GEO, tracking, and lead funnels around them.
- MarTech & technical fluency: marketing automation, GA4 conversion/event tracking, CRM & lead funnels, booking systems, AI content tools (Claude); comfortable with HTML/CSS, no-code/low-code, APIs, a bit of Python for data, and SQL basics. Enough tech to ship and measure end-to-end without a dev queue.
- Selected client work: Serene Touch Pest Control (site + local SEO + lead funnel), Paradise Wellness (spa booking + local marketing), BarberBook (barbershop booking + retention), and a marketing-automation system he built (with built-in GEO / AI-search visibility audits).
